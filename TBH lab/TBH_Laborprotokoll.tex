...
% 			min. lang erhitzt, damit der restlicher Lack gegen Ätzmittel noch
% 			resistenter wird.\\
...
% 			um das Phosphorglas von der Oberfläche zu entfernen. Übrig
% 			bleibender Phosphor wurde anschließend mit dem Wattestäbchen
...
%     	\vspace{2em}
% 
%     	Quelle: http://de.wikipedia.org/wiki/PhysikalischeGasphasenabscheidung\\
%  		\\
...
% 			($H_{3}PO_{4} +H_{2}O+HNO_{3}$). Es wurde mehrmals in der
% 			Zehner-Intervall (je zehn Sekunden in der Lösung) geätzt, danach
