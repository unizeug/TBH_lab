...
\begin{quote}
    ...
    richtet sich nach der Ladungsträgerkonzentration. Ist die Anzahl der 
    Minoritäten in etwa so groß, oder größer wie die 
    Majoritäten spricht man von starker Injekion. Andernfalls spricht man von 
    schwacher Injektion.\\
  ...
  \subsection{Durchführung und Auswertung}
    ...
    \vspace{2em}
            ...
            \begin{table}[H]
              \begin{addmargin}[1.5cm]{3cm}
                \centering
                   \begin{tabular}{|p{4cm}|p{3cm}|p{4.5cm}|}
                    \hline
                    DIE/Zeile/Spalte/Struktur & Bahnwiderstand &  Minoritätsträgerlebensdauer\\
                    \hline
                    2/8/6/Biggi 2 & 15 $\Omega$ & 0.298 µs \\
                    \hline
                    3/6/1/Biggi 2 & 22 $\Omega$ & 1.6 µs \\
                    \hline
                    2/8/6/große Finger & 20 $\Omega$ & 10 µs \\
                    \hline
                    3/6/1/große Finger & 15  $\Omega$ & 1.25 µs \\
                    \hline
                    \end{tabular}
              \end{addmargin}
    ...
    Da eine Lebensdauer von um die 50 µs erwartet wird, liegen die Werte doch 
    ein ganzes Ende davon entfernt. Sie zeigen allerdings ein relativ konstantes
    Verhalten. Lediglich bei der einen großen Fingerstruktur zentral auf dem 
    Wafer sind größere Abweichungen zu erkennen. Da die Grenzfläche der 
    pn-Übergänge zwischen den Fingerstrukturen deutlich größer sind als bei den
    Biggistrukturen, ist hier die Fehleranfälligkeit durch Verunreinigungen auch 
    wesentlich größer. Die Bahnwiderstände sind alle im 
...
\begin{quote}
    ...
    Minoritätsträgerbeweglichkeit bei der jeweiligen Temeperatur ablesen.
    Bei dem von uns verwendeten p-dotierten Siliziumbulk beträgt die
    Beweglichkeit, laut der Tabelle aus ''Silizium-Planartechnologie'', von
    Hans-Günther Wagemann, Seite 62, $\mu_n = 1300 \frac{1}{cm^2Vs}$ bei einer
    Temperatur von $300K$.
    Dies wiederum ergibt mit $D_n = \frac{kT}{e} \cdot \mu_n = U_T \cdot \mu_n$
    den Wert $D_n = 32,5 \frac{1}{cm^2s}$. 
    ...
    entstehen diese Minoritätsträgerlebensdauer:
              ...
              \begin{addmargin}[-0.5cm]{3cm}
                \centering
                   \begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
                    ...
                    \hline
                    304,2  & 27,6 &  1,6 ($22 \Omega$ Bahnwiderstand)\\
                    \hline
                    304,6  & 27,67 &  27 (Kommutierung, 2:1)\\
                    \hline
                    304,3  & 27,62 &  49 (Kommutierung, 1:2)\\
                    \hline
                    304,6  & 27,67 &  136 (Kommutierung, 1:6)\\
                    \hline
    ...
    gewisse Abweichung zwischen den $\tau_n$-Werten zu erkennen, obwohl die
    $\tau_n$, berechnet aus den Diffusionslängen, dem Erwartungswert von $50\mu
    s$ relativ nahe kommen.\\ 
    Diese Abweichung führen wir auf einen unklaren
    Fehler bei der Schaltverhaltenmessung zurück, da bei dieser Messung nur die Minderheit der Ergebnisse 
    die Erwartungen an die Messreihe erfüllt haben.
